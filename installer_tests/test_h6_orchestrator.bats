...
_load_stub_probes() {
    ...
    for fn in _audit_probe_wp_core_version _audit_probe_wp_plugin_updates \
              ...
              _audit_probe_mariadb_reachable _audit_probe_https_enforced \
              _audit_probe_security_headers _audit_probe_ports_open \
              _audit_probe_server_header_hidden _audit_probe_docker_images_pinned; do
