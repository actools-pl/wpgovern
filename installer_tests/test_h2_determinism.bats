...
setup() {
    ...
    wpgovern::state::set_fact "stack.images.wordpress_digest" "sha256:dddd$(printf '%0.sd' {1..60})"
    wpgovern::state::set_fact "stack.images.cli_digest"       "sha256:eeee$(printf '%0.se' {1..60})"
}
