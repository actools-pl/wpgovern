...
wpgovern::db::wait_for_ready() {
    ...
    # H.3.1-7: env-overridable for test speed (defaults preserve production behavior)
    local timeout="${WPGOVERN_DB_WAIT_TIMEOUT:-180}"
    local interval="${WPGOVERN_DB_WAIT_INTERVAL:-5}"
    local elapsed=0
