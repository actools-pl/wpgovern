...
wpgovern::host::packages::install() {
    ...
    local required=(
        ...
        apt-transport-https
        age              # H.3: age-encryption for credentials state and backup encryption
        python3          # H.5: Python control plane host dependency
        python3-venv     # H.5: venv support for Python package installation
    )
